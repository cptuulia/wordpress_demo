...
jQuery('.btn-upload-image').on('click', function (ev) {
  ...
  resize.croppie('result', {
    ...
    jQuery.ajax({
      url: "/wp-content/plugins/kamergro_program/admin/ajax/categoryThumpbnailUpload.php",
      type: "POST",
      data: {
            "image":img, 
            'id': "<?php echo $categoryItem['id']?>",
            'categoryId': "<?php echo $categoryItem['category_id']?>",
             'name' : "<?php echo $categoryItem['name']?>",
        },
