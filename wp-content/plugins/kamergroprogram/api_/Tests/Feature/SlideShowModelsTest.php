...
class kamergroProgramModelsTest extends BaseTest
{
    ...
    public function testMedia(): void
    {
        ...
        $eventPageUrl = 'https://staging-9a16-kamermuziekfestivalgroningen.wpcomstaging.com/lunchconcert-en-masterclass/';
        $id = $mMedia->insert([
            'name' => 'testMedia',
        ...
        $this->assertEquals('testMedia', $media['name']);
         ...
         $this->assertEquals($eventPageUrl, $media['event_page_url']);
