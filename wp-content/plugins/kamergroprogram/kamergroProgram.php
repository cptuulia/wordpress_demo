...
class KamergroProgram {
          public function __construct()
    {
        add_action('admin_menu', [$this, 'adminProgramMenu']);
         ...
         /** [kamergroprogram categoryid="2"]  */
        add_shortcode('kamergroprogram',  [$this, 'kamergroProgram']);
    }
    ...
    function kamergroProgram(array $params) {
        $categoryId = $params['categoryid'];
        ob_start();
        include 'front/program.php';
...
wp_register_script('kamergroprogram_croppie_script', plugins_url('plugins/jquery/croppie/croppie.js', __FILE__), array('jquery'));
wp_enqueue_script('kamergroprogram_croppie_script');
wp_register_style('kamergroprogram_croppie_css', '/wp-content/plugins/kamergroprogram/plugins/jquery/croppie/croppie.min.css');
wp_enqueue_style('kamergroprogram_croppie_css');
